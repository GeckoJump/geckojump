...
const StickyNavbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed flex transition-all z-[990] duration-150 ${isNavOpen ? 'h-full [body]:overflow-y-hidden' : ''} justify-center w-full z-[999] bg-background bg-opacity-100 left-1/2 -translate-x-1/2 shadow-xl`}>
      <div className="container lg:w-3/5 w-3/4 py-3 ">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Link className="z-[990]" to='/'>
          ...
          <div className="absolute top-0 z-[990] left-0 w-1/3 justify-evenly">
