  ...
  return (
    <div id="values-section" ref={ref} className='snap-center scroll-mt-20'>
      <div className={`flex flex-col justify-center align-middle duration-1000 ${inView ? 'transition-all opacity-100 translate-y-0' : 'transition-none opacity-0 translate-y-8'}`}>
        ...
        <div className='grid md:grid-cols-2 sm:grid-cols-1 xl:grid-cols-3 xl:grid-rows-1 xl:max-w-screen-xl w-2/3 max-w-screen-sm grid-rows-[1fr,1fr] mx-auto gap-6 lg:mt-8'>
          <ValueItem
            index={0}
          ...
          <ValueItem
            ...
            icon={<IconImage src={TailoredServiceIcon} alt='Tailored Service' size={172} className='' />}
          />
          <ValueItem
            index={2}
