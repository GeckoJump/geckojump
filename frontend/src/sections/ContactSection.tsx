  ...
  return (
    <div ref={ref} id="contact-section" className="flex flex-col items-center w-full justify-center py-12 bg-neutral-100">
      <div className="flex flex-col items-center w-3/4 lg:w-1/2 justify-center">
        ...
        <p className={`text-gray-500 px-4 md:px-0 text-center mb-10 text-pretty ${viewClasses} delay-200`}>Ready to experience a tech partnership that values your business as much as you do? Reach out to us. </p>
